 ...
 * @since 7.0
 */
public class MyRangeValidator<T extends Comparable> extends AbstractValidator<T> {
     ...
     */
    public MyRangeValidator(String errorMessage, Class<T> type, T minValue,
            T maxValue) {
        super(errorMessage);
        this.type = type;
    ...
    protected boolean isValidValue(T value) {
    	...
    	System.out.println(" VALUE = " + value + ", MIN_VALUE = " + getMinValue() + " - MAX_VALUE = " + getMaxValue());
        ...
        if (getMaxValue() != null) {
            ...
            if (result > 0) {
            	...
            	System.out.println("D " + " VALUE = " + value + ", MAX_VALUE = " + getMaxValue() + " - RESULT = " + value.compareTo(getMaxValue()));

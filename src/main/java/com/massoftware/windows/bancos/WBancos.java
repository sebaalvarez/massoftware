...
public class WBancos extends Window {
	...
	public WBancos() {
		...
		try {
			...
			nombreOficialTXTHL = UtilUI.buildTXTHL(filterBI, "nombre",
			...
			bloqueadoOG = UtilUI.buildBooleanOG(filterBI, "bloqueado", "Situación",
					false, false, "Bloquado", "No bloqueado", true, 0);

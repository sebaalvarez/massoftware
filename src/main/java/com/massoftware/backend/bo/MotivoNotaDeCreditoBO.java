...
public class MotivoNotaDeCreditoBO extends GenericBO<MotivoNotaDeCredito> {

	private final String ATT_NAME_CODIGO = "codigo";
	private final String ATT_NAME_NOMBRE = "nombre";

	public MotivoNotaDeCreditoBO(DataSourceWrapper dataSourceWrapper,
			BackendContext cx) {
		super(MotivoNotaDeCredito.class, dataSourceWrapper, cx);
	}

	public List<MotivoNotaDeCredito> findAll() throws Exception {
	...
	public boolean delete(MotivoNotaDeCredito dto) throws Exception {
	...
	public MotivoNotaDeCredito insert(MotivoNotaDeCredito dto, Usuario usuario)
			throws Exception {

		return insertByReflection(dto, usuario);
	}

	public MotivoNotaDeCredito update(MotivoNotaDeCredito dto,
			MotivoNotaDeCredito dtoOriginal, Usuario usuario) throws Exception {

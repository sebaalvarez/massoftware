...
public class TicketBO extends GenericBO<Ticket> {

	private final String ATT_NAME_CODIGO = "codigo";
	private final String ATT_NAME_NOMBRE = "nombre";

	public TicketBO(DataSourceWrapper dataSourceWrapper, BackendContext cx) {
		super(Ticket.class, dataSourceWrapper, cx);
	}
	...
	public boolean delete(Ticket dto) throws Exception {
	...
	public Ticket insert(Ticket dto, Usuario usuario) throws Exception {

		return insertByReflection(dto, usuario);
	}

	public Ticket update(Ticket dto, Ticket dtoOriginal, Usuario usuario)
			throws Exception {

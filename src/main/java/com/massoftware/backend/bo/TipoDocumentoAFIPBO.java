...
public class TipoDocumentoAFIPBO extends GenericBO<TipoDocumentoAFIP> {

	private final String ATT_NAME_CODIGO = "codigo";
	private final String ATT_NAME_NOMBRE = "nombre";

	public TipoDocumentoAFIPBO(DataSourceWrapper dataSourceWrapper, BackendContext cx) {
		super(TipoDocumentoAFIP.class, dataSourceWrapper, cx);
	}

	public List<TipoDocumentoAFIP> findAll() throws Exception {
	...
	public boolean delete(TipoDocumentoAFIP dto) throws Exception {
	...
	public TipoDocumentoAFIP insert(TipoDocumentoAFIP dto, Usuario usuario) throws Exception {

		return insertByReflection(dto, usuario);
	}

	public TipoDocumentoAFIP update(TipoDocumentoAFIP dto, TipoDocumentoAFIP dtoOriginal, Usuario usuario)
			throws Exception {

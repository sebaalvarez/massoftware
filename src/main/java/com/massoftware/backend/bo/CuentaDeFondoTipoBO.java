...
public class CuentaDeFondoTipoBO extends GenericBO<CuentaDeFondoTipo> {

//	private final String ATT_NAME_CODIGO = "codigo";
//	private final String ATT_NAME_NOMBRE = "nombre";

	public CuentaDeFondoTipoBO(DataSourceWrapper dataSourceWrapper,
			BackendContext cx) {
		super(CuentaDeFondoTipo.class, dataSourceWrapper, cx);
	}

	public List<CuentaDeFondoTipo> findAll() throws Exception {

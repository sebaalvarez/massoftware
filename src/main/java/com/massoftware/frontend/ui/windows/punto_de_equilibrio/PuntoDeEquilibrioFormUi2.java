...
public class PuntoDeEquilibrioFormUi2 extends CustomComponent {
	...
	protected PuntoDeEquilibrioTableUi2 puntoDeEquilibrioTableUi;
	...
	public PuntoDeEquilibrioFormUi2(Window window, BackendContext cx,
	...
	public PuntoDeEquilibrioFormUi2(Window window, BackendContext cx,
			PuntoDeEquilibrioTableUi2 puntoDeEquilibrioTableUi,
			EjercicioContable ejercicioContable) {
		super();
		try {
			this.isForInsertForm = true;

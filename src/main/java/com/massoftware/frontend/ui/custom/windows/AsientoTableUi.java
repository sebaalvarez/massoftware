...
public class AsientoTableUi extends StandardTableUi<Asiento> {
	...
	protected void addControlsFilters() throws Exception {
		...
		filaFiltro0HL.addComponent(filtroEjercicioCBX);
		filaFiltro0HL.setComponentAlignment(filtroEjercicioCBX,
				Alignment.MIDDLE_CENTER);

		filaFiltro0HL.addComponent(filtroNumeroHL);
		filaFiltro0HL.setComponentAlignment(filtroNumeroHL,
				Alignment.MIDDLE_CENTER);
